...
(function (IHashContainer) {
    ...
    function construct(source, Source, bucketFactory) {
        ...
        if (args.length === 1 && args[0] instanceof Source) {
            ...
            var tuple = IAssociativeContainer_1.IAssociativeContainer.construct.apply(IAssociativeContainer_1.IAssociativeContainer, __spreadArray([source], __read(args)));
