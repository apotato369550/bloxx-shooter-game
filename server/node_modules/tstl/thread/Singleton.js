...
var Singleton = /** @class */ (function () {
     ...
     */
    Singleton.prototype.is_loaded = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ret;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, SharedLock_1.SharedLock.lock(this.mutex_, function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                ret = (this.value_ === NOT_MOUNTED_YET);
                                return [2 /*return*/];
                            });
                        }); })];
                    case 1:
